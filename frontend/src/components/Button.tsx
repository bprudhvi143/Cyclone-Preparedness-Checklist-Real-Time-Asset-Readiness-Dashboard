...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    secondary: "bg-accent hover:bg-accent/90 text-white focus:ring-accent/50 shadow-sm",
    danger: "bg-critical hover:bg-critical/90 text-white focus:ring-critical/50 shadow-sm",
    outline:
      "border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 focus:ring-slate-200",
